...
import Account from "./Report Components/Account";
...
class Report extends Component {
  ...
  switchView(view) {
    switch (view) {
      ...
      case "CE":
        return <CalculatedExpenses {...this.state} />;
      default:
        return <ReportDetail {...this.state} />;
    }
  }

  render() {
    const { activeTab, showWelcome } = this.state;
    ...
    return (
      <div className="report_container">
        ...
        <main className="report_content">
          ...
          <div className="view-content">{this.switchView(activeTab)}</div>
          <AddExpenseModal
            open={this.openModal}
